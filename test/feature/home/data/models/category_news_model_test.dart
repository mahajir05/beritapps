...
import 'package:beritapps/feature/home/data/model/categorynews/category_news_model.dart';
import 'package:flutter_test/flutter_test.dart';

import '../../../../fixture/fixture_reader.dart';

void main() {
  const tCategoryNewsModel = CategoryNewsModel(
    image: 'testImage',
    title: 'testTitle',
  );
  ...
  test(
    ...
    () async {
      // assert
      expect(tCategoryNewsModel.props,
          [tCategoryNewsModel.image, tCategoryNewsModel.title]);
    },
  );
    ...
    test(
      ...
      () async {
        ...
        final Map<String, dynamic> jsonMap =
            json.decode(fixture('category_news_model.json'));
